...
# A list of country choices in the format (value, display)
COUNTRY_CHOICES = [
    ("AL", "Albania"),
    ("DZ", "Algeria"),
    ("AS", "American Samoa"),
...
class Application(models.Model):
    ...
    visa_grant_date = models.DateField(auto_now_add=True)
    ...
    def save(self, *args, **kwargs):
        if self.visa_use_by_date:
            self.visa_expiry_date = self.visa_use_by_date + timedelta(days=2*365)
...
#     def __str__(self):
#         return f"Sponsor {self.name} for {self.applicant}"
